...
import PayAccountUpdateForm from "../PayAccountUpdateForm";
...
const headCells = [
  ...
  { id: "privateId", label: "Private Id" },
  { id: "publicId", label: "Public Id" },
  ...
  const DataSet = [
    {
      ...
      data:
        ...
        records?.map((dat) => [
          ...
          {
            value: dat.privateId ? dat.privateId : "null",
            style: { font: { sz: "14" } },
          },
          {
            value: dat.publicId ? dat.publicId : "null",
            style: { font: { sz: "14" } },
          },
        ]),
    },
        ...
        <div className="charts">
          <div className="charts__right">
            <div style={{ display: "flex", flexDirection: "row" }}>
              ...
              {records?.length !== 0 ? (
                <ExcelFile
                  filename="Payment Account S Data"
                  fileExtension="xlsx"
                  element={
                    <button
                      type="button"
                ...
                {records?.length == 0
                  ...
                  : recordsAfterPagingAndSorting()?.map((item) => (
                      <TableRow key={item._id}>
                        ...
                        <TableCell>
                          {item.privateId
                            ? item.privateId.substring(0, 10)
                            : null}
                        </TableCell>
                        <TableCell>
                          {item.publicId
                            ? item.publicId.substring(0, 10)
                            : null}
                        </TableCell>
