...
const headdata = [
  { label: "Trip Name", key: "trip" },
  { label: "Ticket Id", key: "ticketId" },
  { label: "Boarding Date", key: "date" },
  { label: "Dept. Time", key: "departure" },
  { label: "Name", key: "name" },
  { label: "Phone No.", key: "phoneNo" },
  { label: "Seat No.", key: "seatNumber" },
];
...
const Main = () => {
  ...
  useEffect(() => {
    const trs =
      ...
      bookingsData.bookings
        .filter((daily) => daily.trips[0].trip.tripType === "Unscheduled")
        .map((x) => x);
  ...
  const addOrEdit = async (bookingData, seatNo, tripData, resetForm) => {
    resetForm();
    setRecordForEdit(null);
    setOpenPopup(false);
    // console.log(seatNo);
  ...
  const editOrAdd = async (bookingData, seatNo, tripData, resetForm) => {
    resetForm();
        ...
        <div className="charts">
          <div className="charts__right">
            <div style={{ display: "flex", flexDirection: "row" }}>
              ...
              {records?.length !== 0 ? (
                <ExcelFile
                  filename="Unscheduled Booking Data"
                  fileExtension="xlsx"
                  element={
                    <button
                      type="button"
                  ...
                  <ExcelSheet
                    dataSet={DataSet}
                    name="Unscheduled Booking Report"
                  />
                </ExcelFile>
              ) : null}
            </div>
