...
export default function BranchUpdateForm(props) {
  ...
  // values.formattedAddress !== null && address == null
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      ...
      dispatch(editBranch(branchData, recordForEdit._id));

      // {
      loading === false && dispatch(fetchBranches());
      dispatch(fetchBranches());
      // editOrAdd(branchData, resetForm);
      ...
      <Grid container>
        <Grid item xs={6}>
          ...
          <Controls.Input
            ...
            value={
              values.address && values.phoneNo == null
                ? (values.phoneNo = values.address.phoneNo)
                : values.phoneNo != ""
        ...
        <Grid item xs={6}>
          <Controls.Input
            ...
            // value={values.zip}
            value={
              values.address && values.zip == null
          ...
          <Controls.Input
            ...
            // value={values.city}
            value={
              values.address && values.city == null
          ...
          <Controls.Select
            ...
            // value={values.region}
            value={
              values.address && values.region == null
                ? (values.region = values.address.region)
                : values.region != ""
