...
export default function BookingUpdateForm(props) {
  ...
  const validate = (fieldValues = values) => {
    ...
    if ("tripS" in fieldValues)
      temp.tripS =
        fieldValues.tripS.length != 0 ? "" : "This field is required.";
    setErrors({
      ...temp,
    });
        ...
        if (validate()) {
          ...
          let x1 = setInterval(function () {
            ...
            if (distance1 < 0) {
              ...
              editOrAdd(bookingData, seatNo, tripData, resetForm);
            }
          }, 1000);
          // }
          // }
      ...
      <Grid container>
        <Grid
          ...
          <Controls.TripSelect
            ...
            value={
              values.tripS == null
                ? (values.tripS = values.trips[0].trip._id)
                : values.tripS != ""
                ? (values.tripS = values.tripS)
                : (values.tripS = "")
            }
